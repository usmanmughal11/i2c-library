...
export default css`
  ...
  .i2c-theme-light {
    ...
    --i2c-primary-25: var(--i2c-blue-25);
    ...
    --i2c-success-25: var(--i2c-green-25);
    --i2c-success-50: var(--i2c-green-50);
    --i2c-success-100: var(--i2c-green-100);
    --i2c-success-200: var(--i2c-green-200);
    --i2c-success-300: var(--i2c-green-300);
    --i2c-success-400: var(--i2c-green-400);
    --i2c-success-500: var(--i2c-green-500);
    --i2c-success-600: var(--i2c-green-600);
    --i2c-success-700: var(--i2c-green-700);
    --i2c-success-800: var(--i2c-green-800);
    --i2c-success-900: var(--i2c-green-900);
    --i2c-success-950: var(--i2c-green-950);

    --i2c-warning-50: var(--i2c-color-amber-50);
    --i2c-warning-100: var(--i2c-color-amber-100);
    --i2c-warning-200: var(--i2c-color-amber-200);
    --i2c-warning-300: var(--i2c-color-amber-300);
    --i2c-warning-400: var(--i2c-color-amber-400);
    --i2c-warning-500: var(--i2c-color-amber-500);
    --i2c-warning-600: var(--i2c-color-amber-600);
    --i2c-warning-700: var(--i2c-color-amber-700);
    --i2c-warning-800: var(--i2c-color-amber-800);
    --i2c-warning-900: var(--i2c-color-amber-900);
    --i2c-warning-950: var(--i2c-color-amber-950);

    --i2c-danger-25: var(--i2c-red-25);
    --i2c-danger-50: var(--i2c-red-50);
    --i2c-danger-100: var(--i2c-red-100);
    --i2c-danger-200: var(--i2c-red-200);
    --i2c-danger-300: var(--i2c-red-300);
    --i2c-danger-400: var(--i2c-red-400);
    --i2c-danger-500: var(--i2c-red-500);
    --i2c-danger-600: var(--i2c-red-600);
    --i2c-danger-700: var(--i2c-red-700);
    --i2c-danger-800: var(--i2c-red-800);
    --i2c-danger-900: var(--i2c-red-900);
    --i2c-danger-950: var(--i2c-red-950);

    --i2c-neutral-25: var(--i2c-gray-25);
    --i2c-neutral-50: var(--i2c-gray-50);
    --i2c-neutral-100: var(--i2c-gray-100);
    --i2c-neutral-200: var(--i2c-gray-200);
    --i2c-neutral-300: var(--i2c-gray-300);
    --i2c-neutral-400: var(--i2c-gray-400);
    --i2c-neutral-500: var(--i2c-gray-500);
    --i2c-neutral-600: var(--i2c-gray-600);
    --i2c-neutral-700: var(--i2c-gray-700);
    --i2c-neutral-800: var(--i2c-gray-800);
    --i2c-neutral-900: var(--i2c-gray-900);
    --i2c-neutral-950: var(--i2c-gray-950);
