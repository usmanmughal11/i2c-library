...
export default css`
  ...
  .i2c-theme-light {
    ...
    --i2c-blue-25: hsl(203, 80%, 98%);
    --i2c-blue-50: hsl(199, 64%, 92%);
    --i2c-blue-100: hsl(200, 65%, 87%);
    --i2c-blue-200: hsl(200, 67%, 81%);
    --i2c-blue-300: hsl(200, 70%, 75%);
    --i2c-blue-400: hsl(201, 72%, 70%);
    --i2c-blue-500: hsl(200, 74%, 64%);
    --i2c-blue-600: hsl(200, 76%, 59%);
    --i2c-blue-700: hsl(200, 57%, 47%);
    --i2c-blue-800: hsl(200, 60%, 35%);
    --i2c-blue-900: hsl(200, 63%, 24%);
    --i2c-blue-950: hsl(200, 63%, 35%);

    --i2c-green-25: hsl(143, 50%, 97%);
    --i2c-green-50: hsl(143, 49%, 88%);
    --i2c-green-100: hsl(143, 51%, 80%);
    --i2c-green-200: hsl(143, 53%, 72%);
    --i2c-green-300: hsl(143, 55%, 63%);
    --i2c-green-400: hsl(143, 57%, 55%);
    --i2c-green-500: hsl(142, 66%, 47%);
    --i2c-green-600: hsl(143, 97%, 38%);
    --i2c-green-700: hsl(142, 100%, 31%);
    --i2c-green-800: hsl(141, 100%, 24%);
    --i2c-green-900: hsl(140, 100%, 16%);
    --i2c-green-950: hsl(140, 100%, 25%);

    --i2c-red-25: hsl(12, 83%, 98%);
    --i2c-red-50: hsl(11, 86%, 91%);
    --i2c-red-100: hsl(11, 87%, 85%);
    --i2c-red-200: hsl(11, 85%, 79%);
    --i2c-red-300: hsl(10, 86%, 73%);
    --i2c-red-400: hsl(11, 86%, 66%);
    --i2c-red-500: hsl(11, 85%, 60%);
    --i2c-red-600: hsl(11, 86%, 54%);
    --i2c-red-700: hsl(10, 79%, 43%);
    --i2c-red-800: hsl(10, 84%, 32%);
    --i2c-red-900: hsl(11, 89%, 21%);
    --i2c-red-950: hsl(11, 89%, 30%);

    --i2c-orange-25: hsl(36, 83%, 98%);
    --i2c-orange-50: hsl(34, 86%, 92%);
    --i2c-orange-100: hsl(34, 86%, 85%);
    --i2c-orange-200: hsl(34, 87%, 79%);
    --i2c-orange-300: hsl(34, 87%, 73%);
    --i2c-orange-400: hsl(34, 86%, 67%);
    --i2c-orange-500: hsl(34, 86%, 61%);
    --i2c-orange-600: hsl(34, 86%, 55%);
    --i2c-orange-700: hsl(33, 75%, 44%);
    --i2c-orange-800: hsl(34, 80%, 33%);
    --i2c-orange-900: hsl(34, 84%, 22%);
    --i2c-orange-950: hsl(34, 84%, 28%);

    --i2c-black-25: hsl(0, 0%, 96%);
    --i2c-black-50: hsl(0, 2%, 87%);
    --i2c-black-100: hsl(0, 1%, 79%);
    --i2c-black-200: hsl(300, 1%, 70%);
    --i2c-black-300: hsl(0, 1%, 62%);
    --i2c-black-400: hsl(330, 1%, 54%);
    --i2c-black-500: hsl(330, 1%, 45%);
    --i2c-black-600: hsl(340, 2%, 37%);
    --i2c-black-700: hsl(330, 1%, 29%);
    --i2c-black-800: hsl(0, 2%, 20%);
    --i2c-black-900: hsl(340, 5%, 12%);
    --i2c-black-950: hsl(340, 5%, 16%);

    --i2c-gray-25: hsl(240, 11%, 98%);
    --i2c-gray-50: hsl(240, 11%, 93%);
    --i2c-gray-100: hsl(232, 12%, 87%);
    --i2c-gray-200: hsl(235, 12%, 82%);
    --i2c-gray-300: hsl(236, 13%, 77%);
    --i2c-gray-400: hsl(234, 14%, 72%);
    --i2c-gray-500: hsl(237, 13%, 66%);
    --i2c-gray-600: hsl(236, 14%, 61%);
    --i2c-gray-700: hsl(235, 10%, 49%);
    --i2c-gray-800: hsl(237, 10%, 37%);
    --i2c-gray-900: hsl(235, 10%, 25%);
    --i2c-gray-950: hsl(235, 10%, 30%);
    ...
    --i2c-color-primary-25: var(--i2c-blue-25);
    --i2c-color-primary-50: var(--i2c-blue-50);
    --i2c-color-primary-100: var(--i2c-blue-100);
    --i2c-color-primary-200: var(--i2c-blue-200);
    --i2c-color-primary-300: var(--i2c-blue-300);
    --i2c-color-primary-400: var(--i2c-blue-400);
    --i2c-color-primary-500: var(--i2c-blue-500);
    --i2c-color-primary-600: var(--i2c-blue-600);
    --i2c-color-primary-700: var(--i2c-blue-700);
    --i2c-color-primary-800: var(--i2c-blue-800);
    --i2c-color-primary-900: var(--i2c-blue-900);
    --i2c-color-primary-950: var(--i2c-blue-950);

    --i2c-color-success-25: var(--i2c-green-25);
    --i2c-color-success-50: var(--i2c-green-50);
    --i2c-color-success-100: var(--i2c-green-100);
    --i2c-color-success-200: var(--i2c-green-200);
    --i2c-color-success-300: var(--i2c-green-300);
    --i2c-color-success-400: var(--i2c-green-400);
    --i2c-color-success-500: var(--i2c-green-500);
    --i2c-color-success-600: var(--i2c-green-600);
    --i2c-color-success-700: var(--i2c-green-700);
    --i2c-color-success-800: var(--i2c-green-800);
    --i2c-color-success-900: var(--i2c-green-900);
    --i2c-color-success-950: var(--i2c-green-950);
    ...
    --i2c-color-danger-25: var(--i2c-red-25);
    --i2c-color-danger-50: var(--i2c-red-50);
    --i2c-color-danger-100: var(--i2c-red-100);
    --i2c-color-danger-200: var(--i2c-red-200);
    --i2c-color-danger-300: var(--i2c-red-300);
    --i2c-color-danger-400: var(--i2c-red-400);
    --i2c-color-danger-500: var(--i2c-red-500);
    --i2c-color-danger-600: var(--i2c-red-600);
    --i2c-color-danger-700: var(--i2c-red-700);
    --i2c-color-danger-800: var(--i2c-red-800);
    --i2c-color-danger-900: var(--i2c-red-900);
    --i2c-color-danger-950: var(--i2c-red-950);

    --i2c-color-neutral-25: var(--i2c-gray-25);
    --i2c-color-neutral-50: var(--i2c-gray-50);
    --i2c-color-neutral-100: var(--i2c-gray-100);
    --i2c-color-neutral-200: var(--i2c-gray-200);
    --i2c-color-neutral-300: var(--i2c-gray-300);
    --i2c-color-neutral-400: var(--i2c-gray-400);
    --i2c-color-neutral-500: var(--i2c-gray-500);
    --i2c-color-neutral-600: var(--i2c-gray-600);
    --i2c-color-neutral-700: var(--i2c-gray-700);
    --i2c-color-neutral-800: var(--i2c-gray-800);
    --i2c-color-neutral-900: var(--i2c-gray-900);
    --i2c-color-neutral-950: var(--i2c-gray-950);
    ...
    --i2c-font-size-large: 1.125rem;
    --i2c-font-size-x-large: 1.25rem;
    --i2c-font-size-2x-large: 1.75rem;
    --i2c-font-size-3x-large: 2.5rem;
    --i2c-font-size-4x-large: 4rem;
    ...
    --i2c-line-height-1: 1px;
    --i2c-line-height-2: 2px;
    --i2c-line-height-3: 3px;
    --i2c-line-height-4: 4px;
    --i2c-line-height-5: 5px;
    --i2c-line-height-6: 6px;
    --i2c-line-height-7: 7px;
    --i2c-line-height-8: 8px;
    --i2c-line-height-9: 9px;
    --i2c-line-height-10: 10px;
    --i2c-line-height-11: 11px;
    --i2c-line-height-12: 12px;
    --i2c-line-height-13: 13px;
    --i2c-line-height-14: 14px;
    --i2c-line-height-15: 15px;
    --i2c-line-height-16: 16px;
    --i2c-line-height-17: 17px;
    --i2c-line-height-18: 18px;
    --i2c-line-height-19: 19px;
    --i2c-line-height-20: 20px;
    --i2c-line-height-21: 21px;
    --i2c-line-height-22: 22px;
    --i2c-line-height-23: 23px;
    --i2c-line-height-24: 24px;
    --i2c-line-height-25: 25px;
    --i2c-line-height-26: 26px;
    --i2c-line-height-27: 27px;
    --i2c-line-height-28: 28px;
    --i2c-line-height-29: 29px;
    --i2c-line-height-30: 30px;
    --i2c-line-height-31: 31px;
    --i2c-line-height-32: 32px;

    --i2c-ring-1: ;

    --i2c-focus-ring-color: var(--i2c-color-primary-50);
    --i2c-focus-ring-style: solid;
    --i2c-focus-ring-width: var(--i2c-spacing-1);
    --i2c-focus-ring: var(--i2c-focus-ring-style) var(--i2c-focus-ring-width)
      var(--i2c-focus-ring-color);
    --i2c-focus-ring-offset: 1px;
    --i2c-focus-ring-offset-0: 0;

    --i2c-focus-ring-color-default: var(--i2c-color-gray-100);
    --i2c-focus-ring-color-primary: var(--i2c-color-primary-50);
    --i2c-focus-ring-color-success: var(--i2c-color-success-50);
    --i2c-focus-ring-color-danger: var(--i2c-color-danger-50);
    --i2c-focus-ring-color-warning: var(--i2c-color-warning-50);

    --i2c-focus-ring-default: var(--i2c-focus-ring-style)
      var(--i2c-focus-ring-width) var(--i2c-focus-ring-color-default);
    --i2c-focus-ring-primary: var(--i2c-focus-ring-style)
      var(--i2c-focus-ring-width) var(--i2c-focus-ring-color-primary);
    --i2c-focus-ring-success: var(--i2c-focus-ring-style)
      var(--i2c-focus-ring-width) var(--i2c-focus-ring-color-success);
    --i2c-focus-ring-danger: var(--i2c-focus-ring-style)
      var(--i2c-focus-ring-width) var(--i2c-focus-ring-color-danger);
    --i2c-focus-ring-warning: var(--i2c-focus-ring-style)
      var(--i2c-focus-ring-width) var(--i2c-focus-ring-color-warning);
    ...
    --i2c-button-font-size-2x-large: var(--i2c-spacing-7);

    --i2c-button-height-small: var(--i2c-spacing-9);
    --i2c-button-height-medium: var(--i2c-spacing-10);
    --i2c-button-height-large: var(--i2c-spacing-11);
    --i2c-button-height-x-large: var(--i2c-spacing-12);
    --i2c-button-height-2x-large: var(--i2c-spacing-13);

    --i2c-button-line-height-small: 1.428;
    --i2c-button-line-height-medium: 1.428;
    --i2c-button-line-height-large: 1.5;
    --i2c-button-line-height-x-large: 1.5;
    --i2c-button-line-height-2x-large: 1.55;

    --i2c-button-border-radius: var(--i2c-border-radius-large);
    ...
    --i2c-input-border-danger-hover: var(--i2c-color-danger-400);
    --i2c-input-border-danger-focus: var(--i2c-color-danger-500);
    --i2c-input-border-danger-disabled: var(--i2c-color-danger-300);

    --i2c-input-border-success: var(--i2c-color-success-300);
    --i2c-input-border-success-hover: var(--i2c-color-success-400);
    --i2c-input-border-success-focus: var(--i2c-color-success-500);
    --i2c-input-border-success-disabled: var(--i2c-color-success-300);
