...
var SlAlert = class extends s {
  constructor() {
    super(...arguments);
    this.hasSlotController = new HasSlotController(this, "icon", "avatar", "link1", "link2");
    ...
    return $`
      ...
      >
        ...
        <div part="message" class="alert__message">
          <slot></slot>
          <div>
            <a part="link1" href="${this.hrefLink1}" class="alert__link">
              <slot name="link1"></slot>
            </a>
            <a part="link2" href="${this.hrefLink2}" class="alert__link">
...
__decorateClass([
  e({ type: String })
], SlAlert.prototype, "hrefLink1", 2);
__decorateClass([
  e({ type: String })
], SlAlert.prototype, "hrefLink2", 2);
__decorateClass([
  e({ reflect: true })
