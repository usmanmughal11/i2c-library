...
var SlAlert = class extends s {
  ...
  render() {
    ...
    const hasLeftImg = this.hasSlotController.test("leftImg");
    ...
    return $`
      ...
      >
        ...
        <span part="leftImg" class="alert__left_mg" style="background:url(${this.leftImg}) no-repeat center center;">
