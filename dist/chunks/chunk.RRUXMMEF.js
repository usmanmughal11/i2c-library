...
var SlAlert = class extends s {
  ...
  render() {
    ...
    ${this.type === "notification" ? $`
      ...
      class="i2c-alert primary">
              <div class="justify-self-start">
                <div class="alert-title ">
                  <span class="badge badge-primary mr-2">New Feature</span>
                  <span class="font-medium text-sm text-primary-800"> We’ve just released a new
                    feature</span>
                </div>
                <div class="inline-block text-sm text-primary-700">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                </div>
              </div>
              <div class="font-medium items-center">
                <a href="#" class="btn btn-sm btn-base-primary">Learn More</a>
                <a href="#" class="btn btn-sm btn-base-primary">View Changes <span class="icon-arrow-right align-middle"></span> </a>
              </div>
            </div>
      `}
      `;
